...
### 4.1 Univariate: Frequency Counts
...
ggplot(data=ship_data_clean, 
  ...
  coord_flip() +
  theme_classic() +
  ggtitle("Distribution by Ship Type")
```
...
ggplot(data=ship_data_clean, 
  ...
  coord_flip() +
  theme_classic() +
  ggtitle("Distribution by Route Type")
```
...
ggplot(data=ship_data_clean, 
  ...
  coord_flip() +
  theme_classic() +
  ggtitle("Distribution by Maintenance Status")
```
...
ggplot(data=ship_data_clean, 
  ...
  coord_flip() +
  theme_classic() +
  ggtitle("Distribution by Weather Condition")
```
:::

### 4.2 Univariate: Factors affecting Energy Efficiency
...
ggplot(data=ship_data_clean, 
  ...
  stat_summary(fun = "mean", 
               ...
               colour = "darkgrey", 
               vjust = -1) +
  labs(title = "Efficiency (nm per kWh) by Ship Type")
```
...
### 4.3 Univariate: Factors affecting Operational Cost
