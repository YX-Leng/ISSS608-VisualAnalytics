...
ggplot(summarized_trade) +
  ...
  geom_text(data = summarized_trade, 
...
export_treemap <- ggplot(tree_data_exp, aes(area = Total_Amt, fill = Category, label = paste0(Category, "\n", round(Percent, 1), "%"))) +
  geom_treemap() +
  geom_treemap_text(color = "black", place = "center", size = 6) +
  scale_fill_brewer(palette = "Pastel2") +
  labs(title = "Top 3 Exports vs Others") +
  theme_void() +
